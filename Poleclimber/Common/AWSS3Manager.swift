...
//  MLModelTest
//
//  Created by Sivaprasad on 09/06/20.
...
class AWSS3Manager {
    ...
    private init () { }
    let bucketName = "openreachdatabase/without_bounding_box" //5
    ...
    func uploadImage(image: UIImage, fileName: String, progress: progressBlock?, completion: completionBlock?) {
        ...
        let fileName: String = fileName //ProcessInfo.processInfo.globallyUniqueString + (".jpeg")
